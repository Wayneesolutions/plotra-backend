...
//
// WayneRing added an outbound webhook (aivoicebackend PR #5), but Plotra has
// no receiver wired for it yet — this poll is still the only way Plotra
// learns how a call went. Runs as a repeatable BullMQ job (registered once
// below, on module load) rather than reacting to an event, because there is
// still no event being received here (see PLOTRA_HANDOVER_FOR_SANT.md §10.8
// for wiring a receiver as a follow-up).
